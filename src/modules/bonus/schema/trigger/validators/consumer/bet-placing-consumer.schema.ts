...
export const BetPlacingConsumerTriggerConfigSchema =
...
export const BonusTriggerConfigBetPlacingConsumerSchema = z.object({
  type: z.literal(
  ...
  config: BetPlacingConsumerTriggerConfigSchema,
});
